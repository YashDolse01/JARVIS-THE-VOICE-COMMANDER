...
recognition.onresult = function (event) {
  ...
  if(localStorage.getItem("lang") === "en-US"){
   ...
   readOut("sir,I am Jarvis");
   readOut("a voice asistant made by you ");
   readOut("I can do anything which can be done from a browser");
    }
  ...
  // spotify
    ...
    if (transcript.includes("start beast movie") ) {
      readOut("ok sir");
      window.open("https://hdmovie5.tv/movies/raw-beast-2022-hindi-dubbed-predvd/");
    }

     
    if (transcript.includes("start dr strange 2 movie") ) {
      readOut("ok sir");
      window.open("https://hdmovie5.tv/movies/doctor-strange-2-2022-hindi-hq-dubbed/");
    }

    if (transcript.includes("start rrr movie") ) {
      readOut("ok sir");
      window.open("https://hdmovie5.tv/movies/rrr-2022-hindi-dubbed-predvd/");
    }

    if (transcript.includes("start kgf 2 movie") ) {
      readOut("ok sir");
      window.open("https://hdmovie5.tv/movies/k-g-f-chapter-2-2022-hindi/");
    }

    if (transcript.includes("start runway 34 movie") ) {
      readOut("ok sir");
      window.open("https://hdmovie5.tv/movies/runway-34-2022-hindi-predvd/");
    }
    ...
    //google meet
    if (transcript.includes("start science class")) {
      readOut("starting vyanktesh bakshi class");
      let a = window.open(`https://meet.google.com/kvj-mahp-kmj?pli=1&authuser=0`)
      windowsB.push(a)
    }
